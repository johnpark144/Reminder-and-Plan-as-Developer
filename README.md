...
- mytube 프로젝트 CI/CD 하기 ( 로컬에서 에러가 심해서 다시 만들기, next/font 빌트인 되있는 라이브러리로 변경, Home UI 예쁘게 변경, 페이지 폴더와 컴포넌트 폴더 분리)
- StillSteal 프로젝트 CI/CD 하기 (네비 서랍 크기조정, about us 부분 이미지 미리 불러오기, 로그인 장고 서버 체크, Css제거후 Tailwind로 완전히 옮기기)
